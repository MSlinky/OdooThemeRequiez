	...
	def index(self, name):
		...
		if name == 'Requiez':
			...
			data['img'] = [
				...
				'<img class="img-marca" src="/theme_requiez/static/img/marcas/requiez2.jpg"/>',
				'',
				'',
				'',
				''
			...
			data['img'] = [
				...
				'<img class="img-marca" src="/theme_requiez/static/img/marcas/infiniti3.jpg"/>',
				'<img class="img-marca" src="/theme_requiez/static/img/marcas/infiniti4.jpg"/>',
				'<img class="img-marca" src="/theme_requiez/static/img/marcas/infiniti5.jpg"/>',
				'<img class="img-marca" src="/theme_requiez/static/img/marcas/infiniti6.jpg"/>'
			]
		elif name == 'Quadrifoglio' :
			data['nombre'] = 'Quadrifoglio'
			data['urlLogo'] = '<img src="/theme_requiez/static/img/marcas/logoQuadri.png"/>'
